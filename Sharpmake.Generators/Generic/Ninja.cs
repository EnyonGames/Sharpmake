...
{
    // TODO: this is copied from Makefile.cs. Common LLVM / GCC parts should be abstracted and shared.
    public partial class Ninja : IProjectGenerator, ISolutionGenerator
    {
        private const string BuildFileExtension = ".ninja";
